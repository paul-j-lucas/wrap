    ...
    PJL_ARG_END( char *argv[] )
{
    ...
    **    period, question-mark, or an exclamation-point, optionally followed
    **    by a single-quote, double-quote, or a closing parenthesis or bracket.
    **
    ** 2. Allow 2 spaces after the end of a sentence that does not end a line.
    **    This distinction is made so as not to put 2 spaces after a period
    **    that is an abbreviation and not the end of a sentence; periods at the
    **    end of a line will hopefully not be abbreviations.
    **
    ...
    */
    ...
    /*
    ** Number of spaces to output before the next non-white-space character:
    ** set to 1 when we encounter a white-space character and 2 when
    ** was_eos_char is true so as to put 2 characters after the end of a
    ** sentence.
    */
    int  put_spaces         = 0;
    ...
    ** first line of a paragraph and after 'newlines_delimit' or more
    ...
    while ( ( c = getchar() ) != EOF ) {
        ...
        if ( c == '\n' ) {
            ...
            if ( ++consec_newlines >= newlines_delimit ) {
                /*
                ** At least 'newlines_delimit' consecutive newlines: print
                ** text, if any; also set up for indenting.
                */
delimit_paragraph:
                if ( buf_count ) {
            ...
            if ( was_eos_char ) {
                /*
                ** We are joining a line after the end of a sentence: force 2
                ** spaces.
                */
                put_spaces = 2;
                continue;
        ...
        if ( isspace( c ) ) {
            ...
            ** therefore, this white-space character is at the beginning of a
            ** line.
            */
            if ( lead_white_delimit && newline_counter == 0 )
                goto delimit_paragraph;
            /*
            ** Only if we are not at the beginning of a line, remember to
            ** insert 1 space later; allow 2 after the end of a sentence.
            */
        ...
        /*
        ** Treat a quote or a closing parenthesis or bracket as an end-of-
        ** sentence character if it was preceded by a regular end-of-sentence
        ** character.
        */
        ...
        /*
        ** Prepare to slide the partial word to the left we can pick up from
