...
# Released in 1989,
# it has been distributed widely as the shell for the GNU operating system and as a default shell on Linux and OS X.
#
...
# As a pun,
# it expressed that objective in a phrase that sounds similar to born again,
# a term for spiritual rebirth.
