...
1. **Build-time issue**: you get either a compile-time error or warning while building **wrap**.
2. **Run-time issue**: given particular input, **wrap** either gives incorrect output or crashes.
...
**What was the input given to wrap?**

(Please include **_only_** the input necessary to elicit the bug.)

**What output did you expect to be given by wrap?**

**What output was actually given by wrap?**

**If wrap crashed, what was the crash message?**
