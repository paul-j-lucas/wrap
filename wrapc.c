...
** Java comments), '%' (PostScript comments), ';' (assember and Lisp comments),
** and '>' (mail forward indicator).
*/
char        *leading_chars = "\t !#%*/;>";
    ...
    PJL_ARG_END( char *argv[] )
{
    ...
    */
    ...
    /*
    ** Read the first line of input and obtain a string of leading characters
    ** to be removed from all lines.
    */
    ...
    ** of pipes[1].
    **
    ** Read from pipes[1] (the output from wrap) and prepend the leading text
    ** to each line.
    */
    CLOSE( 0 );
    close( pipes[1][1] );
